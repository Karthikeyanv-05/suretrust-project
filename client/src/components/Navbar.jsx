    ...
    return (<>
        ...
        <div className="bg-gradient-to-l from-green-950 via-green-400 to-teal-700 text-white flex md:flex justify-between items-center max-lg:flex-col font-bold p-4  h-16 w-full ">
            ...
            <ul className="flex font-bold text-green-950 font-mono lg:text-2xl left-3/2 space-x-28">
                <li className="p-4">
                    <Link to="/" className="hover:scale-110 hover:text-black">Home</Link>
                </li>
                <li className="p-4 hover:scale-110 hover:text-black">
            ...
            <div>
                <button className="bg-gradient-to-r from-orange-600 via-white to-green-950 text-blue-950 items-center leading-4 px-4 py-2 lg:text-xl rounded-2xl hover:scale-110 hover:text-green-950">
